...
const sortBackwards = (arr) => {
  let reversesorted_array = arr.sort((a, b) => {
    return b - a;
  });
  return reversesorted_array;
};
...
const sortMeetingsByDay = (arr) => {
  ...
  let sortedmeetings = arr.sort((a, b) => {
...
const sortSchedule = (arr) => {
  let sortedstarttimes = arr.sort((a, b) => {
  ...
  let sortedendtimes = sortedstarttimes.sort((a, b) => {
