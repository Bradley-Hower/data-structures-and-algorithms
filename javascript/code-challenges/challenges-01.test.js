...
const addOne = (arr) => {
  let array_plusone = [];
  arr.forEach(element => {
    array_plusone.push(element +1);
  });
  return array_plusone;
};
...
const addExclamation = (arr) => {
  let array_Exclame = [];
  arr.forEach(element => {
    array_Exclame.push(element+'!');
  });
  return array_Exclame;
};
...
const allUpperCase = (arr) => {
  let array_Upper = [];
  arr.forEach(element => {
    array_Upper.push(element.toUpperCase());
  });
  return array_Upper;
};
...
const addNumbers = (num, arr, times, callback) => {
  let pushingnumbers = callback(arr, num)(times);
  return pushingnumbers;
};
