from left_join_pack.linked_list import LinkedList
...
class Hashtable:
  ...
  def left_join(self, hash1, hash2):
    list = [key for key in hash1.keys()]
    list2 = [key for key in hash2.keys()]
